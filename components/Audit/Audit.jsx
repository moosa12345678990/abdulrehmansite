...
import { FaUser, FaEnvelope, FaClipboardList, FaComments, FaRocket, FaChartLine, FaLightbulb, FaCheckCircle, FaPhone, FaCalendarAlt } from 'react-icons/fa';
    ...
    return (
        <div style={{
            ...
            <div style={{
                ...
                <form style={{ display: 'flex', flexDirection: 'column', gap: isMobile ? '1.4rem' : '1.8rem' }}>
                    ...
                    {/* <div style={{
                        ...
                        <p style={{ 
                            ...
                            ⚡ Get your strategy report within 48 hours
                            <br />
                            🔒 Your information is secure and confidential
                            <br />
                            ✉️ No spam. Unsubscribe anytime.
                        </p>
                    </div> */}
                </form>
            </div>
